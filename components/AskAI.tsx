...
function GeminiIcon({ size = 18 }: { size?: number }) {
  // Official Google Gemini logo — Simple Icons (CC0)
  return (
...
function PerplexityIcon({ size = 18 }: { size?: number }) {
  // Official Perplexity logo — Simple Icons (CC0)
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#20B2AA" aria-hidden="true">
