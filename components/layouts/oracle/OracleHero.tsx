...
const ROWS: ResultRow[] = [
  ...
  { id: 2, achievement: "Cloud Account Security",       metric: "2,500+ accounts · 0 breaches",        year: 2025, domain: "cloud"     },
  { id: 3, achievement: "Detection Engineering",        metric: "200+ rules · 0 false positives",      year: 2024, domain: "detection" },
  { id: 4, achievement: "AI Security Pipeline",         metric: "$1.40/run · 55% cost reduction",     year: 2024, domain: "ai"        },
  { id: 5, achievement: "AI Pipeline Scale",            metric: "19 models · 5 providers · 123 reviews", year: 2024, domain: "ai"    },
  ...
  { id: 9, achievement: "Agentic Security Reviews",    metric: "80% effort reduction · 6-wk backlog gone", year: 2024, domain: "ai" },
];
