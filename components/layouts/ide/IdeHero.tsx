...
const FILES: ReadonlyArray<FileTab> = [
  ...
  },
  {
    ...
    lines: [
      ...
      { kind: "text", indent: 2, parts: [{ t: '"securityReviews"', k: "key" }, { t: ": ", k: "punct" }, { t: '"150+"', k: "str" }, { t: ",", k: "punct" }] },
  ...
  },
  {
    ...
    folder: "projects",
    lines: [
      { kind: "comment", text: "# AI-native audit agent: 65+ escalation paths, 10 vulnerability classes." },
      { kind: "comment", text: "# Built the GOAT benchmark first — 32 ground-truth findings — then" },
      { kind: "comment", text: "# evaluated against all 32. Antitoxin: 62 toxic combinations." },
      { kind: "blank" },
      { kind: "text", parts: [{ t: "class ", k: "kw" }, { t: "IamAuditAgent", k: "key" }, { t: ":", k: "punct" }] },
      { kind: "text", indent: 1, parts: [{ t: "escalation_paths ", k: "key" }, { t: "= ", k: "punct" }, { t: '"65+"', k: "str" }] },
